...
export default function AdminBrandingPage() {
  ...
  return (
    <div className="space-y-6 animate-in">
      <div>
        <h1 className="type-page-title text-neutral-light">Branding &amp; Konten</h1>
      ...
      <form onSubmit={handleSave} className="glass-card border rounded-2xl p-6">
        {activeTab === 'umum' && (
          <div className="space-y-4">
            <h2 className="font-ui font-semibold text-neutral-light mb-4 text-base tracking-wide">Identitas Club</h2>
        ...
        {activeTab === 'konten' && (
          <div className="space-y-4">
            <h2 className="font-ui font-semibold text-neutral-light mb-4 text-base tracking-wide">Konten Profil</h2>
        ...
        {activeTab === 'organisasi' && (
          <div className="space-y-4">
            <h2 className="font-ui font-semibold text-neutral-light mb-4 text-base tracking-wide">Struktur Kepengurusan</h2>
            <div className="grid sm:grid-cols-2 gap-4">
        ...
        {activeTab === 'pembayaran' && (
          <div className="space-y-4">
            <h2 className="font-ui font-semibold text-neutral-light mb-4 text-base tracking-wide">Informasi Pembayaran</h2>
            <div className="grid sm:grid-cols-2 gap-4">
        ...
        {activeTab === 'galeri' && (
          <div className="space-y-4">
            <h2 className="font-ui font-semibold text-neutral-light mb-4 text-base tracking-wide">URL Foto Galeri</h2>
            <div className="grid sm:grid-cols-2 gap-4">
        ...
        {activeTab === 'kontak' && (
          <div className="space-y-4">
            <h2 className="font-ui font-semibold text-neutral-light mb-4 text-base tracking-wide">Kontak &amp; Sosial Media</h2>
            <div className="grid sm:grid-cols-2 gap-4">
